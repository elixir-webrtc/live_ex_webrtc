defmodule LiveExWebRTC.CoreComponents do
  # This code is copied from a newly generated Phoenix project.
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(LiveBroadcasterWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(LiveBroadcasterWeb.Gettext, "errors", msg, opts)
    # end
